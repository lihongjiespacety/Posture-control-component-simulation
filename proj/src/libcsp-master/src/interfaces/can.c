...
uint8_t s_canid_au8[CANDEV_NUM]={GPS_CANID,EXT_MAGTM_CANID,WHEEL_X_CANID,WHEEL_Y_CANID,WHEEL_Z_CANID,WHEEL_A_CANID,STAR_SENSOR_CANID,OPTI_GYRO_CANID};  /*新增设备要将CANID添加至此*/
